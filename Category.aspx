    ...
    <h2><b>Category</b></h2>
                ...
                <div class="wrapper">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 inputGroupContainer">
                            <div class="input-group">
                                <asp:textbox id="TextBox1" placeholder="Category name"  cssclass="form-control" runat="server"  required></asp:textbox>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 inputGroupContainer">
                            <div class="input-group">
                                <asp:textbox id="TextBox2" placeholder="Sub Category name" cssclass="form-control" runat="server" required></asp:textbox>
                            </div>
                        </div>
                    </div>
